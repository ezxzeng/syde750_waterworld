...
def display_results(checkpoint_path, save_path, env_name, env):
    ...
    def policy_fn(observation):
        action, _, _ = ApexDDPGagent.get_policy("shared_policy").compute_single_action(
            observation
        )
        return action
...
def waterworld_display(checkpoint_path):
    ...
    register_env(
        "waterworld", lambda _: PettingZooEnv(waterworld_v3.env()),
    )
...
if __name__ == "__main__":
    checkpoints = [
        ...
        for filename in glob.glob(
            "/home/ray/ray_results/APEX_DDPG/APEX_DDPG_custom_waterworld_1_80d21_00000_0_2022-03-28_11-18-45/checkpoint_*/*"
        )
